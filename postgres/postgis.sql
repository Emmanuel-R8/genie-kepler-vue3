...
ALTER COLUMN
  id
SET
  DEFAULT NEXTVAL('biosphere_id_seq');
...
values
  (
    ...
    ST_GeomFromText(
      'POLYGON((-76.205278 44.297778, -75.903611 44.380833, -75.825278 44.430833, -75.809444 44.478611,
...
ALTER COLUMN
  id
SET
  DEFAULT NEXTVAL('office_id_seq');
INSERT into office (name, description, geom)
values
  (
    'Frontenac Arch Biosphere Office',
    '19 Reynolds Road, Lansdowne, ON. Open Monday to Friday 8:30am - 4:30pm',
...
ALTER COLUMN
  id
SET
  DEFAULT NEXTVAL('places_id_seq');
INSERT into places (name, description, geom)
values
  (
    'Brockville',
    'Known as the "City of the 1000 Islands" and Ontario''s first incorporated self-governing town in 1832. Lots of "old" money here! Interesting "underground railroad" history to explore...',
...
values
  (
    'Kingston',
    'Home to Queen''s University, St. Lawrence College and Royal Military College. Only place in Canada where beer consumption actually goes DOWN in the summer with the students partying elsewhere... Indeed, quite a feat!',
...
values
  (
    'Seeley''s Bay',
    'Part of the Rideau Heritage Route on the Rideau Canal. Wonderful charm and facilities to enjoy during the summer months...',
...
values
  (
    'Sharbot Lake',
    'Located in the Land O'' Lakes Tourist Region, Sharbot Lake was once an important stop on the Kingston and Pembroke Railway. The rail bed now constitutes a multi-use section of the Trans-Canada Trail...',
...
values
  (
    'Sydenham',
    'The abandoned CPR/Grand Trunk Railway right-of-way is now part of the Trans-Canada Trail. Great ice cream parlor after another rewarding day hiking the Frontenac Challenge during the autumn months... Trousdale''s, Canada''s oldest general store, has been located here for five generations!',
...
values
  (
    'Verona',
    'A recreational paradise! Ideal place to visit, raise a family, or retire...',
...
values
  (
    'Westport',
    'About 1/3 of the way to Ottawa from Kingston on the winding Rideau Trail. Not quite as affluent as Westport, Connecticut...',
...
values
  (
    'Marble Rock',
    'I dearly want to hike this spectacular trail... someday...',
...
values
  (
    'Holland',
    'Sorry, wrong Holland. No cafes here serving up a pot and hashish menu... yet!',
...
values
  (
    'Inverary',
    'Check out the Inverary Golf and Country Club. Less frustrating than the links courses in Scotland...',
...
values
  (
    'Bedford',
    'Built solid on granite bedrock!',
...
values
  (
    'Sand Bay Corner',
    'Nothing better than the feeling of a sandy bottom and warm water!',
...
values
  (
    'South Frontenac',
    'You guessed it! Located just below the southern expanse of the majestic Frontenac Provincial Park in the heart of beautiful Frontenac County. Close to the Frontenac Challenge trailheads...',
...
values
  (
    'Piccadilly',
    'Escape the circus of living in the big city...',
...
values
  (
    'Rockport',
    'Close your eyes for a moment and you will pass right through town! "Must See" tourist venue with stunning scenery viewable from both land and water...',
...
values
  (
    'Harrowsmith',
    'Home to the magazine of the same name. Ahead of their time. Strong green, ecological, biodiversity and local sustainability roots. No, High Times magazine was not published here!',
...
values
  (
    'Kingston Mills',
    'Start of the historic Rideau Canal. The locks are where a tragic car drowning took place. First mass murder in the history of Kingston sadly...',
...
values
  (
    ...
    'Absolutely magnificant view in all directions!',
...
values
  (
    'Florida',
    'Sorry, wrong Florida! But no worry of hurricanes here...',
...
values
  (
    'Newboro',
    'Founded during the construction of the Rideau Canal and hosts the annual Rideau Lakes Cup Dog Sled Races...',
...
values
  (
    'Landon Bay',
    'Tranquility and a sense of spiritual presence are experienced as one walks the trails and meadows. I would love to live here someday...',
...
values
  (
    'Howe Island',
    'TWO short ferry services connect to the mainland across the Bateau Channel at either end. Take your pick! Kingston to the west and Gananoque to the east...',
...
values
  (
    'Wolfe Island',
    'Lots of steady wind for the turbines! Accessible by ferry from Kingston and Cape Vincent, NY. Largest of the Thousand Islands. Venerable Don Cherry has a summer cottage here...',
...
values
  (
    'Perth Road',
    'Small town on the road to Perth!',
...
values
  (
    'Thousand Islands',
    'Don Ross (FABR Executive Director) published an informative book called "Discovering the Thousand Islands". Great read with lots of pics! Don also owns cool antique mahogany boats...',
...
values
  (
    'Athens',
    'Famous for a series of large outdoor murals depicting historical local life, painted on the sides of various buildings. Delicious Souflaki and Tzatziki sauce!',
...
values
  (
    'Crosby',
    'Sorry, not the hometown of "Sid the Kid"...',
...
values
  (
    'Mallorytown',
    'Local area is a bird watching haven! Duracell batteries in high demand always...',
...
values
  (
    'Grenadier Island',
    'The Grenadier Island Country Club, founded in 1927, is one of the oldest island golf courses in Canada!',
...
values
  (
    'Battersea',
    'Located on the southern shore of Loughborough Lake. Dan Ackroyd has a cottage on this lake famous for its many small islands and natural beauty...',
...
values
  (
    ...
    'KP officially opened on June 1, 1835. Closed September 30, 2013. Was one of the oldest prisons in continuous use in the world and is designated a National Historic Site. Kingston Pen is one of nine prisons in the Kingston area...',
...
values
  (
    'Charleston',
    'Great place to go dancing and reminisce along the shores of Charleston Lake...',
...
values
  (
    'California',
    'Sorry, wrong California! But no traffic conjestion or air pollution here...',
...
values
  (
    'Lansdowne',
    'Quaint community to live within the Biosphere...',
...
values
  (
    'Lake Opinicon',
    'Fisherman''s earthly Heaven and heavenly Earth!',
...
values
  (
    'Glendower',
    'About half way between Piccadilly and Bedford for a restful sleepover...',
...
values
  (
    'Bedford Mills',
    'Mill town (much like the others in the surrounding area) supplied lumber for the construction of the Rideau Canal...',
...
values
  (
    'Front of Yonge',
    'Sorry, the Hockey Hall of Fame is in downtown Toronto at Front and Yonge! Front of Yonge is a local Township...',
...
values
  (
    'Napanee',
    'Napanee is the home of now famous "La Pizzeria", made famous by Avril Lavinge''s declaration that her "favourite pizza" is served there...',
...
ALTER COLUMN
  id
SET
  DEFAULT NEXTVAL('trails_id_seq');
INSERT into trails (name, description, lng, lat, geom)
values
  (
    'Blue Mountain Trail',
    'Moderate 5km. Steep terrain. Awesome romantic views!',
    -76.025152,
    44.494558,
    ST_GeomFromText(
      'LINESTRING(-76.025103 44.494547, -76.023807 44.495356, -76.021906 44.495812, -76.021418 44.496309,
...
values
  (
    'Charleston Lake East Trail',
    'Moderate 10km. Real Canadian Shield wilderness!',
    -76.043048,
    44.499439,
    ST_GeomFromText(
      'LINESTRING(-76.043160 44.499436, -76.039073 44.503404, -76.034741 44.504182, -76.032240 44.506241,
...
values
  (
    'Charleston Lake West Trail',
    'Difficult 15km. Real Canadian Shield wilderness!',
    -76.064538,
    44.500868,
    ST_GeomFromText(
      'LINESTRING(-76.064479 44.500614, -76.051281 44.505879, -76.050239 44.507860, -76.044681 44.509346,
...
values
  (
    'Lemoine Point Conservation Trail',
    'Easy 2km. Great view of Collins Bay. Be wary of low flying aircraft!',
    -76.606428,
    44.216086,
    ST_GeomFromText(
      'LINESTRING(-76.606740 44.222996, -76.605959 44.228712, -76.608216 44.232347, -76.611251 44.230028,
...
values
  (
    'Lyn Valley Conservation Trail',
    'Easy - Moderate 5km. Bring a camera or a paintbrush and canvas!',
    -75.781781,
    44.572347,
    ST_GeomFromText(
      'LINESTRING(-75.781789 44.572240, -75.780664 44.570165, -75.780747 44.567740, -75.783588 44.566888,
...
values
  (
    'Mac Johnson Wildlife Trail',
    'Easy 4km. Go geocaching with the kids!',
    -75.723585,
    44.602382,
    ST_GeomFromText(
      'LINESTRING(-75.723592 44.602265, -75.728281 44.600819, -75.730862 44.600654, -75.734641 44.600321,
...
values
  (
    'Seeley''s Bay Fitness Trail',
    'Light - Moderate. 4km. 14 fitness exercise stations. No fitness club membership necessary!',
    -76.195031,
    44.486368,
    ST_GeomFromText(
      'LINESTRING(-76.194962 44.486054, -76.197083 44.484861, -76.198219 44.483724, -76.200571 44.483992,
